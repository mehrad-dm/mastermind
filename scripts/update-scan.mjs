...
const NEW_NODES = [
  ...
  { id: 'lab', label: 'Quarantine', kind: 'store', sub: 'private data, gitignored', group: 'Safety & honesty', sourceRef: 'skills/quarantine/' },
  {
    ...
    detail:
      'Re-injects the kernel on startup, clear and compact, so it does not fade as context fills. Verified on Claude Code, wired for Cursor. Codex gets none: its hooks need enabling by hand in the TUI.',
  },
  {
    id: 'installtests',
  ...
  {
    id: 'codexrouting',
    label: 'Codex routing eval',
    kind: 'service',
    sub: 'does the brain steer Codex?',
    group: 'Safety & honesty',
    sourceRef: 'evals/codex-routing.mjs',
    detail:
  ...
  },
  {
    ...
    kind: 'service',
    sub: 'one directive, one instruction',
    group: 'Safety & honesty',
    sourceRef: 'scripts/check-instructions.mjs',
    detail:
      'Caps a directive in a skill or agent brief at 30 words and flags hedging: these are instructions parsed by a reader who cannot ask a follow-up. STE-informed; frontmatter and code are skipped.',
  },
  {
    id: 'projectstate',
    label: 'Project state',
